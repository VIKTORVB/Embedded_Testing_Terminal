...
int commStart = 0;
int SDlog = 0;
int ContinuousTransmission = 0;
long length;
int errorCheck = 0;
long errorMax = 0;
long errorMin = 0;
long baudRate = 1667;
long baudRateSelect = 0;
int autoBaud = 0;
char savedMessage[12];
char messageStr[12];
char numberDisplayed[7];
...
void Save_Data() {
    ...
    if (f_mount(&drive, "0:", 1) == FR_OK) {
        if (f_open(&file, "LOG.TXT", 0x30 | 0x02) == FR_OK) {
            f_write(&file, savedMessage, sizeof (savedMessage) - 1, &actualLength);
            f_write(&file, newLine, sizeof (newLine) - 1, &actualLength);
            f_sync(&file);
...
void Error_Check() {
    if (errorCheck == 1) {
        int messageInt = atoi(messageStr);
        if ((messageInt > errorMax || messageInt < errorMin) && messageInt > 0) {
            Display_Character('!');
            messageStr[length + 1] = '!';
        } else {
            Display_Character(' ');
...
void Logging_Check() {
    if (SDlog == 1) {
        strcpy(savedMessage, messageStr);
        Save_Data();
...
void UART_Message() {
    ...
    for (int i = 0; i < length; i++) {
        message = UART1_Read();
        messageStr[i] = message;
        Display_Character(message);
    }
    Error_Check();
    Logging_Check();
}
...
void UART_Check_Command() {
    ...
    message = UART1_Read();
    for (int i = 0; i < 8; i++) {
        if (message == Command_map[i]) {
            UART_Command_Mapper(message);
        } else if (i == 9) {
...
void UART_Start() {
    UART1_Initialize(baudRate, autoBaud);
    GLCD_Clear();

    while (PORTBbits.RB0 == 0) {
        if (ContinuousTransmission == 0) {
            if (commStart == 1) {
                UART_Check_Command();
            } else if (commStart == 0) {
                UART_Check_Comm_Start();
            }
        } else if (ContinuousTransmission == 1) {
            UART_Print();
        }
    }
}
...
void Baud_Rate_Settings()
{
    char autoBaudChar[1];
    sprintf(autoBaudChar, "%d", autoBaud);
...
void Number_Update(long number) {
    sprintf(numberDisplayed, "%d", number);
...
void Baud_rate_Change() {
    GLCD_Clear();
    sprintf(numberDisplayed, "%d", baudRateSelect);
    while (PORTBbits.RB0 == 0) {
        Select_Page(0);
        Command_Write(0b10111010);
        Command_Write(0b01000000);
        ...
        baudRateSelect = Number_Select(baudRateSelect, 999999);
    }
    baudRate = (64000000 / baudRateSelect / 4) - 1;
    GLCD_Clear();
}

void Maximum_Error_Select() {
    GLCD_Clear();
...
void Continous_Transmission_Length() {
    GLCD_Clear();
...
void Menu_Logic() {
    {
        ...
        if (PORTBbits.RB1 == 1 && menu_page == 1 && menu_select == 1) {
            UART_Start();
        }
        if (PORTBbits.RB1 == 1 && menu_page == 1 && menu_select == 2) {
            menu_page = 2;
        ...
        if (menu_page == 2 && menu_select == 1 && PORTBbits.RB1 == 1) {
            menu_page = 3;
            _delay((unsigned long)((100)*(64000000/4000.0)));
            UART_Settings();
        }
        if (menu_page == 2 && menu_select == 2 && PORTBbits.RB1 == 1) {
            menu_page = 4;
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Error_Settings();
        }
        ...
        if (menu_page == 3 && menu_select == 1 && PORTBbits.RB1 == 1) {
            menu_page = 7;
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Transmission_Settings();
        }
        if (menu_page == 3 && menu_select == 2 && PORTBbits.RB1 == 1) {
            menu_page = 6;
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Baud_Rate_Settings();
        }
        ...
        if (menu_page == 4 && menu_select == 1 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            errorCheck = Toggle_Select(errorCheck, 2);
        }
        if (menu_page == 4 && menu_select == 2 && PORTBbits.RB1 == 1) {
            menu_page = 5;
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Error_select_range();
        }
        ...
        if (menu_page == 5 && menu_select == 1 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Maximum_Error_Select();
        }
        if (menu_page == 5 && menu_select == 2 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
        ...
        if (menu_page == 6 && menu_select == 1 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            autoBaud = Toggle_Select(autoBaud, 2);
            Auto_Boud();
        }
        if (menu_page == 6 && menu_select == 2 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            Baud_rate_Change();
        }
        ...
        if (menu_page == 7 && menu_select == 1 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            ContinuousTransmission = Toggle_Select(ContinuousTransmission, 2);
        }
        if (menu_page == 7 && menu_select == 2 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
            SDlog = Toggle_Select(SDlog, 4);
        }
        if (menu_page == 7 && menu_select == 3 && PORTBbits.RB1 == 1) {
            _delay((unsigned long)((100)*(64000000/4000.0)));
...
void Cursor_Position() {
    ...
    while (PORTBbits.RB0 == 0) {
        if (PORTBbits.RB1 == 1)
            Menu_Logic();
            _delay((unsigned long)((100)*(64000000/4000.0)));
        if (PORTBbits.RB3 == 1 && menu_page <= 6 && menu_select < 2) {
            menu_select++;
            Cursor_delete();
            Cursor_drawing();
            _delay((unsigned long)((100)*(64000000/4000.0)));
        }
        if (PORTBbits.RB2 == 1 && menu_page <= 6 && menu_select > 1) {
            menu_select--;
            Cursor_delete();
            Cursor_drawing();
            _delay((unsigned long)((100)*(64000000/4000.0)));
        }
        if (menu_page == 7 && PORTBbits.RB3 == 1 && menu_select < 3) {
            menu_select++;
            Cursor_delete();
            Cursor_drawing();
            _delay((unsigned long)((100)*(64000000/4000.0)));
        }
        if (menu_page == 7 && PORTBbits.RB2 == 1 && menu_select > 1) {
            menu_select--;
            Cursor_delete();
            Cursor_drawing();
            _delay((unsigned long)((100)*(64000000/4000.0)));
